...
<head>
    ...
    <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.0/css/bootstrap.min.css">
    <link rel="stylesheet"
          href="http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.0/css/bootstrap-theme.min.css">
    <!--[if lt IE 9]>
...
<div class="container text-center">
    ...
    <div class="row">
        <form name="f" id="f" onsubmit="return s()">
            <input id="ts" type="text" maxlength="20" size="15" placeholder="Porcodio Search"
                   title="Che bestemmia vuoi cercare"
                   required>
            <input type="submit" class="btn btn-danger" value="Search" title="Cerca una bestemmia">
            <input id="sp" type="button" class="btn btn-danger" value="Spara!"
                   title="Spara una bestemmia a casaccio"
                   onclick="sr()">
        </form>
        <br/>
        <img id="w" src="images/ajax-wait.gif" alt="Attendere cristo" style="display:none">
    </div>
    ...
    <%--    <div class="row">
            <form name="s" id="s" onsubmit="return sy()">
                <input id="ss" type="text" maxlength="20" placeholder="Porcodio Search" title="Che bestemmia vuoi cercare"
                       required>
                <input id="sb" type="button" class="btn btn-danger" value="Spara!" title="Spara una bestemmia a casaccio"
                       onclick="sr()">
            </form>
            <br/>
        </div>

        <div id="thanks" class="row" style="display:none">
            Grazie per il contributo
            <br/>
        </div>--%>

    <div id="disc" class="row discl">
